...
func debugConfig(cfg *config.Config) {
	...
	fmt.Printf("DNSCrypt enabled:  %v (port %d)\n", cfg.DNSCrypt.Enabled, cfg.DNSCrypt.Port)
	fmt.Printf("Interface CLI:     %s\n", cfg.Network.CLIInterface)
	fmt.Printf("Interface Entware: %s\n", cfg.Network.EntwareInterface)
